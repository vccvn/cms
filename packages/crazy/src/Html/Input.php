        ...
        switch(strtolower($type)){
            ...
            case 'crazyselect':
                ...
                <div class="btn-group dropdown deep-select-group '.$select_type.'">
                    <button type="button" class="btn btn-secondary dropdown-toggle show-text-value" id="'.$this->id.'-dropdown" value="'.($def?$def[0]:'').'" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
