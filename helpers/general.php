...
if(!function_exists('get_service_options')){
     ...
     * @param array $args
     */
    function get_service_options(array $args = [], $defaultFirst = null)
    {
        $repository = new ServiceRepository();
        return $repository->where('deleted', 0)->getDataOptions($args, $defaultFirst);
    }
}
...
if(!function_exists('get_services')){
     ...
     * @param array $args
     */
    function get_services(array $args = [])
    {
        $repository = new ServiceRepository();

        return $repository->mode('mask')->getData(array_merge(['deleted'=>0], $args));
    }
}
...
if(!function_exists('get_service')){
     ...
     * lấy danh sách sản phẩm
     * @param array $args
     * @return App\Masks\Services\ServiceMask|null
     */
    function get_service(array $args = [])
    {
        $repository = new ServiceRepository();

        return $repository->mode('mask')->detail(array_merge(['deleted'=>0], $args));
    }
}
...
if(!function_exists('get_service_package_options')){
    /**
     * lấy danh sách sản phẩm
     * @param array $args
     */
    function get_service_package_options(array $args = [])
    {
        if(!isset($args['service_id'])) return [];
        $repository = new PackageRepository();
        return $repository->where('deleted', 0)->getDataOptions($args, null, 'id', 'package_name');
    }
}

if(!function_exists('get_service_package_type_options')){
    /**
     * lấy danh sách sản phẩm
     * @param array $args
     */
    function get_service_package_type_options()
    {
        return [
            'demo' => 'Dùng thử',
            'pro' => 'Pro',
