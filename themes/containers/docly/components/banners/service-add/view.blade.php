<section class="doc_banner_area_one">
    ...
    <div class="container">
        <div class="doc_banner_text">
            ...
            <form action="{{route('client.services.add')}}" class="banner_search_form banner_search_form_two">
                    ...
                    <div class="input-group-prepend">
                        {!!
                            html_input([
                                ...
                                'class' => 'custom-select',
                                'data' => get_service_options([], "Gói dịch vụ"),
                                'default' => $request->service_id
                            ])
                        !!}
                    </div>
                    <input type="text" class="form-control" name="subdomain" placeholder="Tên miền...">
            ...
            <h6>{!! $data->comment('Tất nhiên cái gì cũng phải có cái giá của nó') !!}</h6>
        </div>
    </div>
</section>
