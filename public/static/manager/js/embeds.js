                ...
                if(rs.status){
                    ...
                    if(self.id && data.id == self.id){
                        ...
                        if(itemText.length){
                            ...
                            $('#embed-area-'+area_id).nestable('replace', {id:rs.data.id,content:Crazy.str.eval(self.template, data)});
                        ...
                        $('#embed-area-'+area_id).nestable('add', {id:rs.data.id,content:Crazy.str.eval(self.template, data)});
                        var item = $('#embed-area-'+area_id+' li.dd-item[data-id="'+data.id+'"]');
                        if(item.length){
                            item.prepend(Crazy.str.eval(self.actionTemplate, data));
                        }
