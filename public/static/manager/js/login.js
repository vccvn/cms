        ...
        init:function(){
            ...
            $("#m_login_signin_submit").click(function(e){
                ...
                l.valid()&&(
                    ...
                    // Crazy.ajax(auth_urls.login, "post", {a:1}, cl())
                    l.ajaxSubmit({
                        url:auth.login,
                        type:"post",
                ...
                r.ajaxSubmit({
                    ...
                    success:function(l,s,n,o){
                        if(l.status){
                            ...
                            Crazy.modal.error(l.message);
                            t.removeClass("m-loader m-loader--right m-loader--light").attr("disabled",!1)
                        }
                    },
                    error:function(p){
                        Crazy.modal.error("Đã có lỗi bất ngờ xãy ra. Vui lòng thử lại sau giây lát");
                        t.removeClass("m-loader m-loader--right m-loader--light").attr("disabled",!1)
                    }
                }))
            }),
            $("#m_login_forget_password_submit").click(function(l){
                ...
                r.valid()&&(t.addClass("m-loader m-loader--right m-loader--light").attr("disabled",!0),r.ajaxSubmit({
                    ...
                    error:function(){
                        setTimeout(function(){
                            t.removeClass("m-loader m-loader--right m-loader--light").attr("disabled",!1);
                            Crazy.modal.warning("Lỗi không xác định");
                        },500)
                    }
                }))
            })
