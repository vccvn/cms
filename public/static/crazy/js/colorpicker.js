$(function(){
    if(!Crazy) Crazy = {};
    if(!Crazy.colorpicker) Crazy.colorpicker = (function(){
        var ColorPicker = function(){
            ...
            this.showTable = function (input) {
                $input = input;
                var table = createTable(Crazy.str.rand());
                Crazy.modal.custom({
                    title: "Chọn màu",
                    size: "color-picker",
                    content: table
            ...
            this.showColorPicker = function(input, ChangeColorSelector){
                ...
                Crazy.modal.show("coior-picker-modal", null, function () {
                    self.reset();
                    cl(Crazy.modal.last_open);
                    if(Crazy.modal.last_open != "coior-picker-modal"){
                        Crazy.modal.show(Crazy.modal.last_open);
                    }
                });
            }
            this.init = function(){
