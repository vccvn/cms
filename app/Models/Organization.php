...
class Organization extends Model
{
    ...
    {
        if($this->logo && file_exists( $path = public_path('static/organizations/'.$this->logo))) return $path;
        return null;
    }

    public function getLogo()
    {
        if($this->getLogoPath()) return asset('static/organizations/'.$this->logo);
        return asset('static/organizations/default.png');
