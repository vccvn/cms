                ...
                <div class="m-portlet__body">
                    <div class="m-section mb-0">
                        <div class="m-section__content">';
                            $html.='
                            <div class="dd nestable component-list-body" id="component-area-'.$area->id.'" data-area-id="'.$area->id.'" data-max-depth="1" data-callback="Crazy.components.sortCallback">
                                <ol class="dd-list">
                                    ';
