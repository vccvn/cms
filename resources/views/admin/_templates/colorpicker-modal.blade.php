                            ...
                            <div class="col-md-9 color-range-col order-md-1">
                                ...
                                <div class="row red-range align-items-center">
                                    ...
                                    <div class="col-7 col-sm-8 col-md-9">
                                        <div id="color-picker-r-nouislider" class="crazy-nouislider m-nouislider" data-input-id="color-picker-r-input" data-start="0" data-step="1" data-min="0" data-max="255" data-on-change="Crazy.colorpicker.updateRangeInputValue"></div>
                                    </div>
                                    <div class="col-3 col-sm-2">
                                        <input type="number" name="colorpucker[r]" id="color-picker-r-input" class="form-control range-input-number" data-ref="r" value="0" data-on-change="Crazy.colorpicker.onChangeInputValue">
                                    </div>
                                </div>
                                <div class="row green-range align-items-center">
                                    <label for="color-picker-g-input" class="col-2 col-md-1 col-form-label">G</label>
                                    <div class="col-7 col-sm-8 col-md-9">
                                        <div id="color-picker-g-nouislider" class="crazy-nouislider m-nouislider" data-input-id="color-picker-g-input" data-start="0" data-step="1" data-min="0" data-max="255" data-on-change="Crazy.colorpicker.updateRangeInputValue"></div>
                                    </div>
                                    <div class="col-3 col-sm-2">
                                        <input type="number" name="colorpucker[g]" id="color-picker-g-input" class="form-control range-input-number" data-ref="g" value="0" data-on-change="Crazy.colorpicker.onChangeInputValue">
                                    </div>
                                </div>
                                <div class="row blue-range align-items-center">
                                    <label for="color-picker-b-input" class="col-2 col-md-1 col-form-label">B</label>
                                    <div class="col-7 col-sm-8 col-md-9">
                                        <div id="color-picker-b-nouislider" class="crazy-nouislider m-nouislider" data-input-id="color-picker-b-input" data-start="0" data-step="1" data-min="0" data-max="255" data-on-change="Crazy.colorpicker.updateRangeInputValue"></div>
                                    </div>
                                    <div class="col-3 col-sm-2">
                                        <input type="number" name="colorpucker[b]" id="color-picker-b-input" class="form-control range-input-number" data-ref="b" value="0" data-on-change="Crazy.colorpicker.onChangeInputValue">
                                    </div>
                                </div>
                            </div>
                        </div>
