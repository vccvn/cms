...
<div class="m-area__content">
    <div class="dd nestable component-list-body" id="component-area-{{$area->id}}" data-area-id="{{$area->id}}" data-title-by="{{$title_by}}" data-max-depth="1" data-callback="Crazy.components.sortCallback">
        <ol class="dd-list">
