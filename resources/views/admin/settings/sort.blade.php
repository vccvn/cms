        ...
        <div class="m-section">
            <div class="m-section__content">
                <div class="setting-list">
                    ...
                    <div class="dd nestable setting-item-list-body" id="crazy-setting-item-list" data-max-depth="1" data-callback="Crazy.setting.items.sortCallback">
                        <ol class="dd-list">
                            @if (count($list))
                        ...
                        <div class="col-md-8 col-lg-9">
                            @include($_base.'forms.templates.crazyselect', [
                                'input' => html_input([
                                    ...
                                    '@change' => 'Crazy.setting.items.changeInputType'
                                ])
                            ])
                        </div>
                    </div>
